...
gallery/tb-video-player/1.0/index
 ...
 **/
KISSY.add('gallery/tb-video-player/1.0/index',function (S, Node, Base, DOM, SWF, UA) {
    ...
    function _rendVideoNode (src, VideoConfig, CallBack) {
        ...
        if (PLATFORM.isPC) {
            ...
            var _video_node = DOM.create('<video>', {
                ...
                height: VideoConfig.height,
                controls: 'controls',
                autoplay: VideoConfig.isAutoPlay ? 'autoplay' : EMPTY,
                src: src,
                id: _guid
            });
            $(VideoConfig.container).append(_video_node);
        } else {
